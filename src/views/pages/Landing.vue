...
// Estado reactivo para el menú y el scroll
...
// Detectar el scroll para cambiar la clase del navbar
const handleScroll = () => {
...
<template>
    <div class="bg-surface-0 dark:bg-surface-900">
        <div id="home" class="landing-wrapper overflow-hidden">
            <nav
                :class="[
                    'fixed left-1/2 transform -translate-x-1/2 transition-all duration-300 ease-in-out z-50',
                    {
                        'top-0 w-full bg-transparent': !hasScrolled, // Transparente cuando está en la parte superior
                        'top-4 w-11/12 rounded-full backdrop-blur-md': hasScrolled, // Desenfoque y redondeado al hacer scroll
                        'shadow-lg shadow-gray-500/50': hasScrolled && !isDarkMode, // Sombra oscura en modo claro
                        'shadow-lg shadow-gray-100/30': hasScrolled && isDarkMode // Sombra gris clara en modo oscuro
                    }
                ]"
            ...
            >
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between h-16">
                        ...
                        <div class="flex-shrink-0 text-xl font-bold">
                            <a class="flex items-center" href="#" to="/">
                                <img src="/logo.svg" width="40px" alt="crwdbsness" />
                                <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">crwdbsness</span>
                            </a>
                        </div>
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="hidden md:flex space-x-4">
                                <a href="#" @click="smoothScroll('#highlights')" class="text-lg font-bold text-gray-900 dark:text-white hover:text-sky-600 dark:hover:text-gray-300 content-center">Inicio</a>
                                <a href="#" @click="smoothScroll('#highlights')" class="text-lg font-bold text-gray-900 dark:text-white hover:text-sky-600 dark:hover:text-gray-300 content-center">Servicios</a>
                                <a href="#" @click="smoothScroll('#highlights')" class="text-lg font-bold text-gray-900 dark:text-white hover:text-sky-600 dark:hover:text-gray-300 content-center">Contacto</a>
                                <a href="#" @click="smoothScroll('#highlights')" class="text-lg font-bold text-gray-900 dark:text-white hover:text-sky-600 dark:hover:text-gray-300 content-center">Contacto</a>
                            </div>
                            ...
                            <div class="md:hidden">
                                <button class="text-gray-900 dark:text-white focus:outline-none" @click="toggleMenu">
                ...
                <div v-if="isMenuOpen" class="md:hidden bg-white/40 backdrop-blur-md dark:bg-gray-800/40 p-4 space-y-4 flex flex-col text-end">
                    <a href="#" @click="smoothScroll('#highlights')" class="text-gray-900 dark:text-white  hover:text-sky-600 dark:hover:text-gray-300">Inicio</a>
                    <a href="#" @click="smoothScroll('#highlights')" class="text-gray-900 dark:text-white  hover:text-sky-600 dark:hover:text-gray-300">Servicios</a>
                    <a href="#" @click="smoothScroll('#highlights')" class="text-gray-900 dark:text-white  hover:text-sky-600 dark:hover:text-gray-300">Contacto</a>
                </div>
            </nav>

            <div class="relative isolate px-6 lg:px-8">
                <!-- Fondo degradado - Primera capa -->
                ...
                <!-- Contenido principal -->
                <div class="mx-auto max-w-7xl py-32 sm:py-48 lg:py-56 flex flex-col lg:flex-row items-center gap-16">
                    <!-- Texto a la izquierda -->
                    <div class="text-center lg:text-left flex-1">
                        <h1 class="text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl dark:text-white">Impulsa tus Proyectos y Haz Realidad tus Sueños con crwdbsness</h1>
                        <p class="mt-8 text-lg font-medium text-gray-500 sm:text-xl/8 dark:text-gray-400">
                            En crwdbsness, ayudamos a que tus ideas cobren vida. Somos una plataforma de recaudación de fondos diseñada para impulsar proyectos y negocios de todos los tamaños. Únete a nuestra comunidad y encuentra el apoyo financiero
                            necesario para hacer realidad tus sueños.
                        </p>
                        <div class="mt-10 flex items-center justify-start gap-x-6">
                            ...
                            <a href="#" class="text-sm font-semibold text-gray-900 dark:text-gray-100">Learn more <span aria-hidden="true">→</span></a>
                        </div>
                    </div>
