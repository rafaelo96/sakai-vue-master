    ...
    <div class="bg-surface-0 dark:bg-surface-900">
        <div id="home" class="landing-wrapper overflow-hidden">
            ...
            <nav :class="[
                    ...
                    <div class="flex items-center justify-between h-16">
                        ...
                        <div class="flex-shrink-0 text-xl font-bold">
                            <a class="flex items-center" href="#" to="/">
                                ...
                                <span
                                    class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">crwdbsness</span>
                            </a>
                        </div>
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="hidden md:flex space-x-4">
                                <a href="#"
                                    class="text-lg font-bold text-gray-900 dark:text-white hover:text-sky-600 dark:hover:text-gray-300 content-center">Inicio</a>
                                <a href="#"
                                    class="text-lg font-bold text-gray-900 dark:text-white hover:text-sky-600 dark:hover:text-gray-300 content-center">Servicios</a>
                                <a href="#"
                                    class="text-lg font-bold text-gray-900 dark:text-white hover:text-sky-600 dark:hover:text-gray-300 content-center">Contacto</a>
                ...
                <div v-if="isMenuOpen" class="md:hidden bg-white/40 backdrop-blur-md dark:bg-gray-800/40 p-4 space-y-4">
                    <a href="#"
                        class="text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300">Inicio</a>
                    <a href="#"
                        class="text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300">Servicios</a>
                    <a href="#"
                        class="text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300">Contacto</a>
                </div>
            </nav>
    ...
    <div class="mx-auto max-w-7xl py-32 sm:py-48 lg:py-56 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div class="text-center lg:text-left flex-1">
            <h1 class="text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl dark:text-white">
                Impulsa tus Proyectos y Haz Realidad tus Sueños con crwdbsness
            </h1>
            <p class="mt-8 text-lg font-medium text-gray-500 sm:text-xl/8 dark:text-gray-400">
                En crwdbsness, ayudamos a que tus ideas cobren vida. Somos una plataforma de recaudación de fondos diseñada para impulsar proyectos y negocios de todos los tamaños. Únete a nuestra comunidad y encuentra el apoyo financiero necesario para hacer realidad tus sueños.
            </p>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pb-8 mt-6 lg:mt-0">
                        <div
                            ...
                            <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Well
                                    Documented</div>
                                <span class="text-surface-600 dark:text-surface-200">Non arcu risus quis varius quam
                                    quisque.</span>
                            </div>
                        </div>
                    </div>
